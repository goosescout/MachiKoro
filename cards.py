...
ALL_CARDS = {
    ...
    'convenience_store': Card('cards/Convenience_Store.png', 'Convenience Store', 'bread', (4,),
                              ['Get 3 coins', '(On your turn only)'], 2),
    'cheese_factory': Card('cards/Cheese_Factory.png', 'Cheese Factory', 'factory', (7,),
                           ['Get 3 coins for every', 'Farm you control', '(On your turn only)'], 5),
    'furniture_factory': Card('cards/Furniture_Factory.png', 'Furniture Factory', 'factory', (8,),
                              ['Get 3 coins for every Forest', 'and Mine you control', '(On your turn only)'], 3),
    'market': Card('cards/Fruit_and_Vegetable_Market.png', 'Fruit and Vegetable Market', 'fruit', (11, 12),
                   ['Get 3 coins for every Wheat Field', 'and Apple Orchard you control','(On your turn only)'], 2),
    'cafe': Card('cards/Cafe.png', 'Cafe', 'cup', (3,), ['Get 1 coin from player','who rolled the dice'], 2),
    'family_restaurant': Card('cards/Family_Restaurant.png', 'Family Restaurant', 'cup', (9, 10),
                              ['Get 2 coins from player','who rolled the dice'], 3),
